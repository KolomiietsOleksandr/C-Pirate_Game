        ...
        if (PlayerStep == true)
        {
            if (CriticalBoolPl == true)
            {
                ...
                if (IsAttackedPL.AttackCheker == 1)
                {
                    ...
                    {
                        eventText.text += $"<#fcf403>You gave critical damage: 0 </color> \n";
                    }
                    else
                    {
                        eventText.text += $"<#fcf403>You gave critical damage: {PlayerData.damage * PlayerData.CriticalMultiplier - EnemyData.armor} </color> \n";
                    }
            ...
            if (CriticalBoolPl == false)
            {
                ...
                if (IsAttackedPL.AttackCheker == 1)
                {
                    ...
                    {
                        eventText.text += $"<#fcf403>You gave damage: 0 </color> \n";
                    }
                    else
                    {
                        eventText.text += $"<#fcf403>You gave damage: {PlayerData.damage - EnemyData.armor} </color> \n";
                    }
