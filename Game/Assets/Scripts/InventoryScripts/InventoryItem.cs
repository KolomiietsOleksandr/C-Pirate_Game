...
public class InventoryItem : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    ...
    public bool isClickPending = false;
    private float lastClickTime = 0f;

    private LootButtonController lootButtonController;
    ...
    {   
        ...
        if (currentItem != null)
        {
            ...
            else
            {
                ...
                if (currentSlot.type != SlotType.LootSlot && currentSlot.type != SlotType.SellSlot && currentSlot.type != SlotType.BuySlot && currentSlot.type != SlotType.LootSlot)
                {
                ...
                if (currentSlot.type == SlotType.LootSlot)
                {
                    ...
                    lootButtonController = FindObjectOfType<LootButtonController>();
